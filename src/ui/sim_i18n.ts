...
const baseEnTable = {
	...
	"error.generalAlwaysOn":
		"The General channel is always on - just use /general.",
	"error.noSuchChannel":
		"There is no channel named '{name}'. Channels: {list}.",
...
const BASE_DICT: Record<
	SupportedLanguage,
	Record<BaseSimMessageKey, string>
> = {
	en: {
		"error.lineOfSight": "Line of sight.",
		"error.specLevel": "You may choose a specialization at level {level}.",
	...
	es: {
		...
		"error.cantFollowInCombat":
			"No puedes empezar a seguir mientras estás en combate.",
		"error.targetToFollow":
			"Marca a un jugador para seguirlo, o usa /follow <nombre>.",
		...
		"error.generalAlwaysOn":
			"El canal General siempre está activo: solo usa /general.",
		"error.noSuchChannel":
			"No existe ningún canal llamado '{name}'. Canales: {list}.",
		"error.alreadyInChannel": "Ya estás en el canal {channel}.",
		"error.notInChannel": "No estás en el canal {channel}.",
		"error.notInChannelJoin":
			"No estás en el canal {channel}. Escribe /join {channel} primero.",
		...
		"error.raidMarkersParty":
			"Debes estar en un grupo para usar marcadores de banda.",
		"error.nameSellQty": "Indica cuántos deseas vender.",
		"error.talentsInCombat": "No puedes cambiar de talentos en combate.",
		"error.talentsArena":
			"No puedes cambiar de talentos durante un combate de arena.",
		...
		"error.tameTooHigh":
			"Esa bestia es de nivel demasiado alto para que la domestiques.",
	...
	es_ES: {
		...
		"error.notPartyLeader": "No eres el líder del grupo.",
		"error.raidMarkersParty":
			"Debes estar en un grupo para usar marcas de banda.",
		"error.nameSellQty": "Indica cuántos deseas vender.",
		"error.talentsInCombat": "No puedes cambiar de talentos en combate.",
		"error.talentsArena":
			"No puedes cambiar de talentos durante un combate de arena.",
		...
		"error.tameTooHigh":
			"Esa bestia es de un nivel demasiado alto para que la domes.",
	...
	fr_FR: {
		...
		"error.cantFollowInCombat":
			"Vous ne pouvez pas commencer à suivre quelqu'un en combat.",
		"error.targetToFollow":
			"Ciblez un joueur à suivre, ou utilisez /follow <nom>.",
		...
		"presence.nowDnd":
			"Vous êtes maintenant en mode Ne pas déranger : {message}",
		...
		"error.generalAlwaysOn":
			"Le canal Général est toujours actif - utilisez simplement /general.",
		"error.noSuchChannel":
			"Il n'existe aucun canal nommé « {name} ». Canaux : {list}.",
		...
		"error.specLevel":
			"Vous pourrez choisir une spécialisation au niveau {level}.",
		"error.invalidBuild": "Distribution de talents invalide.",
		"error.unknownSpec": "Spécialisation inconnue.",
		"error.maxLoadouts":
			"Vous pouvez enregistrer au maximum {count} configurations.",
		...
		"error.raidMarkersParty":
			"Vous devez être en groupe pour utiliser les symboles de raid.",
		"error.nameSellQty": "Indiquez la quantité que vous souhaitez vendre.",
		"error.talentsInCombat":
			"Vous ne pouvez pas modifier vos talents en combat.",
		"error.talentsArena":
			"Vous ne pouvez pas modifier vos talents pendant un combat d'arène.",
		"error.noItem": "Vous n'avez pas cet objet.",
		"error.cantWhileDead": "Vous ne pouvez pas faire cela en étant mort.",
		"error.cantWhileSwimming":
			"Vous ne pouvez pas faire cela en train de nager.",
		"error.tameThat": "Vous ne pouvez pas apprivoiser cela.",
		"error.tameBeastsOnly": "Seules les bêtes peuvent être apprivoisées.",
		"error.tameTooStrong":
			"Cette bête est trop puissante pour être apprivoisée.",
		"error.tameTooHigh":
			"Cette bête est d'un niveau trop élevé pour que vous puissiez l'apprivoiser.",
		"error.tameDungeon":
			"Vous ne pouvez pas apprivoiser les créatures de donjon.",
		...
		"log.rareCatch":
			"Une prise rare ! Quelque chose scintille sur votre ligne.",
	...
	it_IT: {
		...
		"error.cantFollowInCombat":
			"Non puoi iniziare a seguire mentre sei in combattimento.",
		"error.targetToFollow":
			"Seleziona un giocatore da seguire oppure usa /follow <nome>.",
		...
		"error.generalAlwaysOn":
			"Il canale Generale è sempre attivo: usa semplicemente /general.",
		"error.noSuchChannel":
			"Non esiste alcun canale chiamato '{name}'. Canali: {list}.",
		"error.alreadyInChannel": "Sei già nel canale {channel}.",
		"error.notInChannel": "Non sei nel canale {channel}.",
		"error.notInChannelJoin":
			"Non sei nel canale {channel}. Digita prima /join {channel}.",
		...
		"error.specLevel":
			"Puoi scegliere una specializzazione al livello {level}.",
		...
		"error.raidMarkersParty":
			"Devi far parte di un gruppo per usare i segnacoli da incursione.",
		"error.nameSellQty": "Indica quanti ne vuoi vendere.",
		"error.talentsInCombat": "Non puoi cambiare i talenti in combattimento.",
		"error.talentsArena":
			"Non puoi cambiare i talenti durante uno scontro in arena.",
		...
		"error.tameTooStrong":
			"Quella bestia è troppo forte per essere addomesticata.",
		"error.tameTooHigh":
			"Quella bestia è di livello troppo alto perché tu possa addomesticarla.",
	...
	de_DE: {
		...
		"error.cantFollowInCombat":
			"Im Kampf könnt Ihr niemandem zu folgen beginnen.",
		"error.targetToFollow":
		...
		"log.channelJoined":
			"Kanal {channel} betreten. Schreibt /{channel} <Nachricht>, um zu reden.",
		"log.channelLeft": "Kanal {channel} verlassen.",
		"error.channelUsage": "Verwendung: /{action} <Kanal>. Kanäle: {list}.",
		"error.generalAlwaysOn":
			"Der Kanal General ist immer aktiv - benutzt einfach /general.",
		"error.noSuchChannel":
			"Es gibt keinen Kanal namens '{name}'. Kanäle: {list}.",
		"error.alreadyInChannel": "Ihr seid bereits im Kanal {channel}.",
		"error.notInChannel": "Ihr seid nicht im Kanal {channel}.",
		"error.notInChannelJoin":
			"Ihr seid nicht im Kanal {channel}. Schreibt zuerst /join {channel}.",
		...
		"error.specLevel":
			"Ihr könnt auf Stufe {level} eine Spezialisierung wählen.",
		...
		"error.loadoutLevel":
			"Für diese Vorlage ist eine höhere Stufe erforderlich.",
		...
		"error.talentsArena":
			"Ihr könnt während eines Arenakampfes keine Talente ändern.",
		...
		"error.tameTooHigh":
			"Dieses Wildtier hat eine zu hohe Stufe, um es zu zähmen.",
	...
	zh_CN: {
		...
		"log.channelJoined":
			"已加入{channel}频道。输入 /{channel} <消息> 即可发言。",
		...
		"error.notInChannelJoin":
			"你不在{channel}频道中。请先输入 /join {channel}。",
	...
	zh_TW: {
		...
		"log.channelJoined":
			"已加入「{channel}」頻道。輸入 /{channel} <訊息> 即可發言。",
		...
		"error.notInChannelJoin":
			"你不在「{channel}」頻道中。請先輸入 /join {channel}。",
	...
	ko_KR: {
		...
		"error.targetToFollow":
			"따라갈 플레이어를 대상으로 지정하거나 /follow <이름>을 사용하세요.",
		...
		"log.channelJoined":
			"{channel} 채널에 들어왔습니다. /{channel} <메시지>를 입력해 대화하세요.",
		"log.channelLeft": "{channel} 채널에서 나갔습니다.",
		"error.channelUsage": "사용법: /{action} <채널>. 채널: {list}.",
		"error.generalAlwaysOn":
			"일반 채널은 항상 켜져 있습니다 - 그냥 /general을 사용하세요.",
		...
		"error.loadoutLevel":
			"해당 특성 묶음을 사용하려면 더 높은 레벨이 필요합니다.",
	...
	ja_JP: {
		...
		"error.channelUsage":
			"使い方：/{action} <チャンネル>。チャンネル：{list}。",
		"error.generalAlwaysOn":
			"一般チャンネルは常にオンです。/generalをそのまま使用してください。",
		"error.noSuchChannel":
			"「{name}」というチャンネルはありません。チャンネル：{list}。",
	...
	pt_BR: {
		...
		"error.cantFollowInCombat":
			"Você não pode começar a seguir alguém durante o combate.",
		"error.targetToFollow":
			"Selecione um jogador para seguir ou use /follow <nome>.",
		...
		"log.channelJoined":
			"Você entrou no canal {channel}. Digite /{channel} <mensagem> para falar.",
		"log.channelLeft": "Você saiu do canal {channel}.",
		"error.channelUsage": "Uso: /{action} <canal>. Canais: {list}.",
		"error.generalAlwaysOn":
			"O canal Geral está sempre ativo - basta usar /general.",
		"error.noSuchChannel":
			"Não existe nenhum canal chamado '{name}'. Canais: {list}.",
		"error.alreadyInChannel": "Você já está no canal {channel}.",
		"error.notInChannel": "Você não está no canal {channel}.",
		"error.notInChannelJoin":
			"Você não está no canal {channel}. Digite /join {channel} primeiro.",
		...
		"error.specLevel":
			"Você pode escolher uma especialização no nível {level}.",
	...
	ru_RU: {
		...
		"error.generalAlwaysOn":
			"Канал «General» всегда включён — просто используйте /general.",
		"error.noSuchChannel":
			"Канала с названием «{name}» не существует. Каналы: {list}.",
		...
		"error.raidMarkersParty":
			"Чтобы использовать рейдовые метки, нужно состоять в группе.",
		...
		"error.tameTooHigh":
			"Этот зверь слишком высокого уровня, чтобы вы могли его приручить.",
...
const PET_DICT_ES: Record<PetSimMessageKey, string> = {
	...
	"error.petClassesRename":
		"Solo las clases con mascota pueden renombrar mascotas.",
	"error.petNameInvalid":
		"El nombre de mascota debe tener 2-16 letras, espacios, guiones o apóstrofos, y empezar con una letra.",
	"error.petClassesRevive":
		"Solo las clases con mascota pueden revivir mascotas.",
	"error.petClassesCommand":
		"Solo las clases con mascota pueden dar órdenes a mascotas.",
	...
	"error.warlocksDemonHeal":
		"Solo los brujos pueden canalizar sanación demoníaca.",
...
const PET_DICT_FR: Record<PetSimMessageKey, string> = {
	...
	"error.huntersAbandonPets":
		"Seuls les chasseurs peuvent abandonner des familiers.",
	"error.petClassesRename":
		"Seules les classes à familier peuvent renommer des familiers.",
	"error.petNameInvalid":
		"Le nom du familier doit contenir 2 à 16 lettres, espaces, traits d'union ou apostrophes, et commencer par une lettre.",
	"error.petClassesRevive":
		"Seules les classes à familier peuvent ranimer des familiers.",
	"error.petClassesCommand":
		"Seules les classes à familier peuvent commander des familiers.",
	...
	"error.warlocksDemonHeal":
		"Seuls les démonistes peuvent canaliser une guérison démoniaque.",
...
const PET_DICT_IT: Record<PetSimMessageKey, string> = {
	...
	"error.petClassesRename":
		"Solo le classi con mascotte possono rinominare mascotte.",
	"error.petNameInvalid":
		"Il nome della mascotte deve avere 2-16 lettere, spazi, trattini o apostrofi e iniziare con una lettera.",
	"error.petClassesRevive":
		"Solo le classi con mascotte possono rianimare mascotte.",
	"error.petClassesCommand":
		"Solo le classi con mascotte possono comandare mascotte.",
	"error.noLivingPet": "Non hai una mascotte viva.",
	"error.petNeedsHostileTarget":
		"La tua mascotte ha bisogno di un bersaglio ostile.",
	...
	"error.warlocksDemonHeal":
		"Solo gli stregoni possono canalizzare cure demoniache.",
...
const PET_DICT_DE: Record<PetSimMessageKey, string> = {
	...
	"error.petClassesRevive":
		"Nur Begleiterklassen können Begleiter wiederbeleben.",
	"error.petClassesCommand":
		"Nur Begleiterklassen können Begleiter befehligen.",
	...
	"error.warlocksDemonHeal":
		"Nur Hexenmeister können Dämonenheilung kanalisieren.",
...
const PET_DICT_ZH_CN: Record<PetSimMessageKey, string> = {
	...
	"error.petNameInvalid":
		"宠物名称必须为 2-16 个字母、空格、连字符或撇号，并以字母开头。",
...
const PET_DICT_ZH_TW: Record<PetSimMessageKey, string> = {
	...
	"error.petNameInvalid":
		"寵物名稱必須為 2-16 個字母、空格、連字號或撇號，並以字母開頭。",
...
const PET_DICT_PT: Record<PetSimMessageKey, string> = {
	...
	"error.petClassesRename":
		"Somente classes com mascote podem renomear mascotes.",
	"error.petNameInvalid":
		"O nome do mascote deve ter 2-16 letras, espaços, hífens ou apóstrofos e começar com uma letra.",
	"error.petClassesRevive":
		"Somente classes com mascote podem reviver mascotes.",
	"error.petClassesCommand":
		"Somente classes com mascote podem comandar mascotes.",
...
const PET_DICT_RU: Record<PetSimMessageKey, string> = {
	...
	"error.petClassesRename":
		"Только классы с питомцами могут переименовывать питомцев.",
	"error.petNameInvalid":
		"Имя питомца должно содержать 2-16 букв, пробелов, дефисов или апострофов и начинаться с буквы.",
	"error.petClassesRevive":
		"Только классы с питомцами могут воскрешать питомцев.",
	"error.petClassesCommand":
		"Только классы с питомцами могут отдавать приказы питомцам.",
	...
	"error.warlocksDemonHeal":
		"Только чернокнижники могут направлять исцеление демона.",
...
export const DICT: Record<
	SupportedLanguage,
	Record<SimMessageKey, string>
> = Object.fromEntries(
	supportedLanguages.map((lang) => [
		lang,
		{ ...BASE_DICT[lang], ...PET_DICT[lang] },
	]),
...
export const ARENA_EXTRA: Record<
	SupportedLanguage,
	Record<ArenaExtraKey, string>
> = {
	en: {
	...
	es: {
		...
		partyLeaderQueue2v2:
			"Solo el líder del grupo puede poner a tu equipo en cola para 2c2.",
		premadeNeedsTwo:
			"Un grupo premade 2c2 requiere un grupo de exactamente dos.",
	...
	fr_FR: {
		join2v2:
			"Vous rejoignez la file 2c2 du Colisée cendré. Attendez des adversaires...",
		...
		partyLeaderQueue2v2:
			"Seul le chef de groupe peut inscrire votre équipe en 2c2.",
		premadeNeedsTwo:
			"Une équipe premade 2c2 requiert un groupe d’exactement deux.",
		...
		memberTrading:
			"{name} doit terminer son échange avant de rejoindre la file.",
	...
	it_IT: {
		join2v2:
			"Entri nella coda 2v2 del Colosseo Cinereo. Attendi gli avversari...",
		...
		partyLeaderQueue2v2:
			"Solo il capogruppo può mettere la squadra in coda per 2v2.",
	...
	de_DE: {
		join2v2:
			"Du trittst der 2v2-Warteschlange des Aschenen Kolosseums bei. Warte auf Gegner...",
		leave2v2: "Du verlässt die 2v2-Warteschlange des Aschenen Kolosseums.",
		teamLeave2v2:
			"Dein Team verlässt die 2v2-Warteschlange des Aschenen Kolosseums.",
		alreadyQueuedOther:
		...
		partyLeaderQueue2v2:
			"Nur der Gruppenleiter kann dein Team für 2v2 einreihen.",
		premadeNeedsTwo:
			"Ein 2v2-Premade erfordert eine Gruppe aus genau zwei Spielern.",
		...
		memberTrading:
			"{name} muss den Handel beenden, bevor die Warteschlange betreten wird.",
	...
	zh_CN: {
		...
		alreadyQueuedOther:
			"你已经在 {current} 队列中。先离开该队列，再加入 {next}。",
	...
	zh_TW: {
		...
		alreadyQueuedOther:
			"你已經在 {current} 佇列中。請先離開該佇列，再加入 {next}。",
	...
	ja_JP: {
		...
		alreadyQueuedOther:
			"すでに {current} キューに入っています。{next} に入る前に離れてください。",
		leaveParty1v1: "1v1 キューに入る前にパーティを離れてください。",
		partyLeaderQueue2v2:
			"パーティリーダーだけがチームを 2v2 キューに入れられます。",
	...
	pt_BR: {
		...
		alreadyQueuedOther:
			"Você já está na fila {current}. Saia dela antes de entrar na fila {next}.",
		leaveParty1v1: "Saia do grupo antes de entrar na fila 1v1.",
		partyLeaderQueue2v2:
			"Só o líder do grupo pode colocar sua equipe na fila 2v2.",
		premadeNeedsTwo:
			"Uma equipe premade 2v2 exige um grupo de exatamente dois.",
	...
	ru_RU: {
		join2v2:
			"Вы вступаете в очередь 2v2 Пепельного Колизея. Ожидайте соперников...",
		...
		partyLeaderQueue2v2:
			"Только лидер группы может поставить вашу команду в очередь 2v2.",
		premadeNeedsTwo:
			"Для заранее собранной команды 2v2 нужна группа ровно из двух игроков.",
...
export const QUEST_EXTRA: Record<
	SupportedLanguage,
	Record<QuestExtraKey, string>
> = {
	en: {
		...
		aldrenYell:
			'{name} yells, "None shall disturb the king\'s rest! For Thornpeak!"',
		malricYell:
			'{name} yells, "Death shall never claim my king! The ritual must endure!"',
	...
	es: {
		...
		ritualBreaks:
			"La Piedra clave de la cripta se vuelve fría cuando se rompe el sello.",
		cryptSealed: "La entrada de la cripta está sellada para ti.",
		awakens: "¡{name} despierta!",
		aldrenYell:
			'{name} grita: "¡Nadie perturbará el descanso del rey! ¡Por Thornpeak!"',
		malricYell:
			'{name} grita: "¡La muerte nunca reclamará a mi rey! ¡El ritual debe perdurar!"',
	...
	fr_FR: {
		...
		ritualBreaks:
			"La clef de la crypte devient froide tandis que le sceau se brise.",
		cryptSealed: "L’entrée de la crypte vous est scellée.",
		awakens: "{name} s’éveille!",
		aldrenYell:
			'{name} crie: "Nul ne troublera le repos du roi! Pour Thornpeak!"',
		malricYell:
			'{name} crie: "La mort ne prendra jamais mon roi! Le rituel doit durer!"',
	...
	it_IT: {
		ritualNeedsKey:
			"Il cerchio rituale tace senza la Chiave di volta della cripta.",
		...
		ritualBreaks:
			"La Chiave di volta della cripta diventa fredda mentre il sigillo si spezza.",
		cryptSealed: "L’ingresso della cripta ti è sigillato.",
		awakens: "{name} si risveglia!",
		aldrenYell:
			'{name} grida: "Nessuno disturberà il riposo del re! Per Thornpeak!"',
		malricYell:
			'{name} grida: "La morte non reclamerà mai il mio re! Il rituale deve durare!"',
	...
	de_DE: {
		...
		aldrenYell:
			'{name} ruft: "Niemand stört die Ruhe des Königs! Für Thornpeak!"',
		malricYell:
			'{name} ruft: "Der Tod soll meinen König nie fordern! Das Ritual muss bestehen!"',
		vossYell:
			'{name} ruft: "Ihr werdet ihn nicht erreichen! Der König muss bestehen!"',
	},
	zh_CN: {
	...
	ko_KR: {
		...
		aldrenYell:
			'{name}이(가) 외칩니다. "누구도 왕의 안식을 방해할 수 없다! Thornpeak를 위하여!"',
		malricYell:
			'{name}이(가) 외칩니다. "죽음은 결코 내 왕을 데려가지 못한다! 의식은 계속되어야 한다!"',
		vossYell:
			'{name}이(가) 외칩니다. "너희는 그에게 닿지 못한다! 왕은 이어져야 한다!"',
	},
	ja_JP: {
		...
		awakens: "{name}が目覚めた！",
		aldrenYell:
			"{name}が叫ぶ。「王の眠りを乱す者は許さぬ！ Thornpeakのために！」",
		malricYell: "{name}が叫ぶ。「死は我が王を奪えぬ！ 儀式は続かねばならぬ！」",
		vossYell: "{name}が叫ぶ。「お前たちは王に届かぬ！ 王は永らえねばならぬ！」",
	},
	pt_BR: {
		ritualNeedsKey:
			"O círculo ritual fica em silêncio sem a Pedra-chave da cripta.",
		...
		aldrenYell:
			'{name} grita: "Ninguém perturbará o descanso do rei! Por Thornpeak!"',
		malricYell:
			'{name} grita: "A morte jamais levará meu rei! O ritual deve perdurar!"',
	...
	ru_RU: {
		...
		aldrenYell:
			'{name} кричит: "Никто не потревожит покой короля! За Thornpeak!"',
		malricYell:
			'{name} кричит: "Смерть никогда не заберет моего короля! Ритуал должен сохраниться!"',
		vossYell:
			'{name} кричит: "Вы не доберетесь до него! Король должен сохраниться!"',
	},
};
...
export const ITEM_EXTRA: Record<
	SupportedLanguage,
	Record<ItemExtraKey, string>
> = {
	en: {
...
const RAID_EXTRA: Record<SupportedLanguage, Record<RaidExtraKey, string>> = {
	...
	es: {
		...
		needFullParty:
			"Necesitas un grupo completo de cinco antes de convertirlo en banda.",
		...
		noDuelArena:
			"No puedes batirte en duelo en la Arena de banda de Nythraxis.",
	...
	fr_FR: {
		...
		needFullParty:
			"Il faut un groupe complet de cinq avant de le convertir en raid.",
		...
		noDuelArena:
			"Vous ne pouvez pas lancer de duel dans larene de raid de Nythraxis.",
		noStandardDungeons:
			"Les raids ne peuvent pas entrer dans les donjons standards.",
	...
	it_IT: {
		...
		needFullParty:
			"Serve un gruppo completo da cinque prima di convertirlo in raid.",
		...
		noStandardDungeons:
			"I gruppi raid non possono entrare nelle spedizioni standard.",
		...
		engagedSealed:
			"Nythraxis e in combattimento; la porta reale si e sigillata.",
	...
	de_DE: {
		...
		noDuelArena:
			"In der Nythraxis-Schlachtzugsarena koennt Ihr nicht duellieren.",
		noStandardDungeons:
			"Schlachtzuege koennen keine Standarddungeons betreten.",
		mustConvert:
			"Ihr muesst Eure Gruppe zuerst in einen Schlachtzug umwandeln.",
		royalDoorSealed: "Die koenigliche Tuer ist Euch versiegelt.",
		locked: "Ihr seid an die Nythraxis-Schlachtzugsarena gebunden.",
		engagedSealed:
			"Nythraxis ist im Kampf; die koenigliche Tuer hat sich versiegelt.",
		mustFall:
			"Die koenigliche Tuer ist versiegelt; Nythraxis muss zuerst fallen.",
	},
	zh_CN: {
	...
	ja_JP: {
		...
		mustFall:
			"王家の扉は封印されています。先にナイスラクシスを倒さねばなりません。",
	},
	pt_BR: {
		converted: "Seu grupo foi convertido em raide.",
		memberMoved: "{name} foi movido para o grupo de raide {group}.",
		needFullParty:
			"Voce precisa de um grupo completo de cinco antes de converter para raide.",
	...
	ru_RU: {
		...
		needFullParty:
			"Для преобразования в рейд нужна полная группа из пяти игроков.",
		...
		noStandardDungeons:
			"Рейдовые группы не могут входить в обычные подземелья.",
...
function locGearReadout(worn: string, total: string, body: string): string {
	const items = body
		...
		.map((seg) => {
			...
			const locValue =
				value === "(empty)" ? tItemExtra("gearEmptySlot") : locItem(value);
...
const RULES: Rule[] = [
	...
	},
	{
		...
		build: (m) =>
			t("game.talents.readout.summary", {
				head:
					m[1] === "no specialization"
						? t("game.talents.readout.noSpec")
						: m[1],
				spent: m[2],
				total: m[3],
	...
	},
	{
		...
		build: () =>
			tQuestExtra("aldrenYell", { name: locMob("Fallen Captain Aldren") }),
	},
	{
		re: /^Corrupted Priest Malric yells, "Death shall never claim my king! The ritual must endure!"$/,
		build: () =>
			tQuestExtra("malricYell", { name: locMob("Corrupted Priest Malric") }),
	},
	{
	...
	{
		re: /^Chat locked for (\d+)s because you are sending messages too quickly\.$/,
		build: (m) => t("hud.errors.chatLocked", { seconds: m[1] }),
	},
	{
		re: /^You dismiss (.+)\.$/,
	...
	},
	{
		re: /^(.+) is now (.+)\.$/,
		build: (m) =>
			tSim("log.petMode", { name: locMob(m[1]), mode: locPetMode(m[2]) }),
	},
	{
		re: /^(.+) dies\.$/,
	...
	},
	{
		re: /^(.+) wins (.+) \((\d+)\)$/,
		build: (m) =>
			tSim("loot.rollWin", { winner: m[1], item: locItem(m[2]), roll: m[3] }),
	},
	...
	},
	{
		...
		build: (m) =>
			tSim("log.abilityRankUp", { name: locAbility(m[1]), rank: m[2] }),
	},
	...
	// default labels are themselves keys, custom text splices through verbatim.
	{
		...
		build: (m) =>
			tSim("presence.nowAfk", {
				message:
					m[1] === "Away From Keyboard" ? tSim("presence.afkDefault") : m[1],
			}),
	},
	{
	...
	},
	{
		...
		build: (m) =>
			tArenaExtra("alreadyQueuedOther", { current: m[1], next: m[2] }),
	},
	{
