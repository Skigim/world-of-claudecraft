	...
	elder_bristleback: {
		...
		loot: [
			...
			{ itemId: "crossroads_saber", chance: 0.3 },
			{
				...
				chance: 0.25,
				rollGroup: "elder_bristleback_chase",
			},
			{
	...
	sableweb_matriarch: {
		...
		loot: [
			...
			{ itemId: "wanderers_chestguard", chance: 0.3 },
			{
				...
				chance: 0.25,
				rollGroup: "sableweb_matriarch_chase",
			},
			{
	...
	grix_the_tunnelking: {
		...
		loot: [
			...
			{ itemId: "tunnelkings_spade", chance: 0.3 },
			{
				itemId: "moggers_copper_cudgel",
				chance: 0.25,
				rollGroup: "grix_tunnelking_chase",
			},
			{
				itemId: "hollowbone_hauberk",
				chance: 0.25,
...
export const ZONE1_NPCS: Record<string, NpcDef> = {
	...
	ranger_elwyn: {
		...
		greeting:
			"Quiet, $C — the glade is calm today, and I mean to keep it that way.",
	},
};
...
export const ZONE1_QUESTS: Record<string, QuestDef> = {
	...
	q_mogger: {
		...
		objectives: [
			{ type: "kill", targetMobId: "mogger", count: 1, label: "Mogger slain" },
		],
		xpReward: 1200,
		copperReward: 900,
		itemRewards: {
	...
	q_ledger_reedwater: {
		...
		completionText:
			"That will keep the long-legged thieves off my nets for a season. Tell the Marshal the shallows are mine again.",
		objectives: [
			{
				type: "kill",
				targetMobId: "meadow_crane",
				count: 8,
