...
export const ZONE3_MOBS: Record<string, MobTemplate> = {
	...
	ironvein_foreman: {
		...
		loot: [
			...
			{
				itemId: "gutripper_shiv",
				chance: 0.25,
				rollGroup: "ironvein_foreman_chase",
			},
			{
	...
	marrowlord_varkas: {
		...
		loot: [
			...
			{ itemId: "marrowlord_boneboots", chance: 0.3 },
			{
				...
				chance: 0.25,
				rollGroup: "marrowlord_varkas_chase",
			},
		],
		scale: 1.25,
		color: 0xd8d0bd,
	...
	voskar_emberwing: {
		...
		loot: [
			...
			{
				itemId: "emberwing_legguards",
				chance: 0.25,
				rollGroup: "voskar_emberwing_chase",
			},
			{
				itemId: "emberfang_warblade",
				chance: 0.25,
				rollGroup: "voskar_emberwing_chase",
			},
		],
...
export const ZONE3_QUESTS: Record<string, QuestDef> = {
	...
	q_shard_cores: {
		...
		objectives: [
			{ type: "collect", itemId: "storm_core", count: 6, label: "Storm Core" },
		],
		xpReward: 3700,
		copperReward: 1800,
		itemRewards: {},
	...
	q_nythraxis_sealed_crypt: {
		...
		copperReward: 2500,
		itemRewards: {
			warrior: "crypt_keystone",
			mage: "crypt_keystone",
			rogue: "crypt_keystone",
		},
...
export const ZONE3_CAMPS: CampDef[] = [
	...
	{
		mobId: "deeprock_kobold",
		center: { x: 105, z: 600 },
		radius: 14,
		count: 6,
	},
	{
		mobId: "ironvein_foreman",
		center: { x: 100, z: 617 },
		radius: 5,
		count: 1,
	},
