...
export const ZONE2_MOBS: Record<string, MobTemplate> = {
	...
	sloomtooth_the_drowned: {
		...
		loot: [
			...
			{ itemId: "mudfin_scale", chance: 1 },
			{
				itemId: "tidereaver_gaff",
				chance: 0.25,
				rollGroup: "sloomtooth_chase",
			},
			{
				itemId: "sloomtooth_tidefang",
				chance: 0.25,
				rollGroup: "sloomtooth_chase",
			},
			{
				itemId: "drowned_tide_scepter",
				chance: 0.25,
				rollGroup: "sloomtooth_chase",
			},
		],
...
export const ZONE2_QUESTS: Record<string, QuestDef> = {
	...
	q_widows: {
		...
		objectives: [
			{
				type: "kill",
				targetMobId: "mire_widow",
				count: 10,
				label: "Mirefen Widow slain",
			},
			{
				type: "collect",
				itemId: "widow_venom_sac",
				count: 6,
	...
	q_mistcaller: {
		...
		copperReward: 2500,
		itemRewards: {
			warrior: "mistcallers_edge",
			mage: "vaels_mist_staff",
			rogue: "riptide_dirk",
		},
		requiresQuest: "q_bastion_door",
		minLevel: 12,
...
export const ZONE2_CAMPS: CampDef[] = [
	...
	{
		mobId: "deepfen_murloc",
		center: { x: -120, z: 350 },
		radius: 13,
		count: 6,
	},
	{
		mobId: "mirejaw_the_ravenous",
		center: { x: -132, z: 333 },
		radius: 5,
		count: 1,
	},
	...
	{
		mobId: "gravecaller_summoner",
		center: { x: -5, z: 500 },
		radius: 12,
		count: 4,
	},
	{
		mobId: "gravecaller_mender",
		center: { x: 18, z: 472 },
		radius: 8,
		count: 2,
	},
